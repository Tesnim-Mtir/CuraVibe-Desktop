...
public class HistoriqueRecycleController implements Initializable {
        ...
        if (selectionModel.isEmpty()) {
            ...
            try {
                ...
                for (Fruit fruit : selectedItems) {
                    ...
                    try (PreparedStatement statement = connection.prepareStatement("DELETE FROM medicament_recycles WHERE id = ?")) {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ajouterButton.setOnAction(event -> {
            try {
                // Load the FXML file
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/recycle.fxml"));
                Parent root = loader.load();
                // Create a new scene
    ...
    private void populateTableView() {
        ...
        try {
            ...
            String query = "SELECT id, name, etat, quantite  FROM medicament_recycles";
            statement = connection.prepareStatement(query);
            resultSet = statement.executeQuery();

            while (resultSet.next()) {
                int id = resultSet.getInt("id");
                String donationName = resultSet.getString("name");
    ...
    private void editData() {
        ...
        name.setOnEditCommit(event -> {
            ...
            try {
                connection = Db.getConnection();
                String query = "UPDATE medicament_recycles SET name = ? WHERE id = ?";
                statement = connection.prepareStatement(query);
        ...
        etat.setOnEditCommit(event -> {
            ...
            try {
                connection = Db.getConnection();
                String query = "UPDATE medicament_recycles SET etat = ? WHERE id = ?";
                statement = connection.prepareStatement(query);
